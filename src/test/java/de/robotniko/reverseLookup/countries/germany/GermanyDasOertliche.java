...
public class GermanyDasOertliche {
	...
	@Test
	public void testDirk() throws ReverseLookupException, ParserConfigurationException, SAXException, IOException {
		Person expected = new Person();
		...
		Helper.testNumberOnSite(service, "+498962021830", SEARCH_SITE_NAME, expected);
	}
}
